...
public class PoliceCar extends Sprite {
  ...
  // EACH TILE HAS AN ID, WHICH WE'LL USE FOR SORTING
    ...
    public Intersection getLocation() {
     ...
     public void invokeMindlessTerror() {
        carVelocity *=5;
    }
    ...
    public boolean isCarStopped = false;
    
    public void setCarStopped(boolean value) {
        isCarStopped = value;
    }
...
//            y = targetY;
    ...
    public void update(MiniGame game) {
        ...
        else if (calculateDistanceToTarget() < carVelocity) {
            vX = 0;
            vY = 0;
            x = targetX;
            y = targetY;
