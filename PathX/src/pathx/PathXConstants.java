...
public class PathXConstants {
    ...
    public static final String BUTTON_CLOSE_TYPE = "BUTTON_CLOSE_TYPE";
     ...
     //SPECIALS TYPES
    public static final String SPECIAL_STEAL_TYPE = "SPECIAL_STEAL_TYPE";
    public static final String SPECIAL_FLY_TYPE = "SPECIAL_FLY_TYPE";
    public static final String SPECIAL_INVINCIBILITY_TYPE = "SPECIAL_INVINCIBILITY_TYPE";
    public static final String SPECIAL_INCREASE_SPEED_TYPE = "SPECIAL_INCREASE_SPEED_TYPE";
    public static final String SPECIAL_INTANGIBILITY_TYPE = "SPECIAL_INTANGIBILITY_TYPE";
    public static final String SPECIAL_FLAT_TIRE_TYPE = "SPECIAL_FLAT_TIRE_TYPE";
    public static final String SPECIAL_EMPTY_GAS_TYPE = "SPECIAL_EMPTY_GAS_TYPE";
    public static final String SPECIAL_MINDLESS_TERROR_TYPE = "SPECIAL_MINDLESS_TERROR_TYPE";
