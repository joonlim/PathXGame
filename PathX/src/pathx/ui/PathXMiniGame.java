...
import static pathx.PathX.PathXPropertyType.SPECIAL_INCREASE_SPEED;
...
//    private JButton homeButton;
    ...
    public void switchToLevelSelectScreen() {
        ...
        if (isCurrentScreenState(GAME_SCREEN_STATE)) {
            ...
            setStealDisabled();
            setFlyDisabled();
            setInvincibleDisabled();
            setIncreasedSpeedDisabled();
...
//         ((PathXDataModel)data).enableCars(false);
    ...
    public void initGUIControls() {
        ...
        //SPECIALS
        //STEAL $200
        String specialSteal = props.getProperty(PathXPropertyType.SPECIAL_STEAL);
        sT = new SpriteType(SPECIAL_STEAL_TYPE);
        img = loadImage(imgPath + specialSteal);
        sT.addState(PathXCarState.VISIBLE_STATE.toString(), img);
        sT.addState(PathXCarState.MOUSE_OVER_STATE.toString(), img);
        s = new Sprite(sT, 10/*x coordinates*/, 90/*y coordinates*/, 0, 0, PathXCarState.INVISIBLE_STATE.toString());
        guiButtons.put(SPECIAL_STEAL_TYPE, s);
        //FLY $300
        String specialFly = props.getProperty(PathXPropertyType.SPECIAL_FLY);
        sT = new SpriteType(SPECIAL_FLY_TYPE);
        img = loadImage(imgPath + specialFly);
        sT.addState(PathXCarState.VISIBLE_STATE.toString(), img);
        sT.addState(PathXCarState.MOUSE_OVER_STATE.toString(), img);
        s = new Sprite(sT, 10/*x coordinates*/, 120/*y coordinates*/, 0, 0, PathXCarState.INVISIBLE_STATE.toString());
        guiButtons.put(SPECIAL_FLY_TYPE, s);
        //INVINCIBILITY $400
        String specialInvincibility = props.getProperty(PathXPropertyType.SPECIAL_INVINCIBILITY);
        sT = new SpriteType(SPECIAL_INVINCIBILITY_TYPE);
        img = loadImage(imgPath + specialInvincibility);
        sT.addState(PathXCarState.VISIBLE_STATE.toString(), img);
        sT.addState(PathXCarState.MOUSE_OVER_STATE.toString(), img);
        s = new Sprite(sT, 10/*x coordinates*/, 150/*y coordinates*/, 0, 0, PathXCarState.INVISIBLE_STATE.toString());
        guiButtons.put(SPECIAL_INVINCIBILITY_TYPE, s);
        //INVINCIBILITY $500
        String specialIncreaseSpeed= props.getProperty(PathXPropertyType.SPECIAL_INCREASE_SPEED);
        sT = new SpriteType(SPECIAL_INCREASE_SPEED_TYPE);
        img = loadImage(imgPath + specialIncreaseSpeed);
        sT.addState(PathXCarState.VISIBLE_STATE.toString(), img);
        sT.addState(PathXCarState.MOUSE_OVER_STATE.toString(), img);
        s = new Sprite(sT, 10/*x coordinates*/, 180/*y coordinates*/, 0, 0, PathXCarState.INVISIBLE_STATE.toString());
        guiButtons.put(SPECIAL_INCREASE_SPEED_TYPE, s);
        //INTANGIBILITY $500
        String specialIntangibility = props.getProperty(PathXPropertyType.SPECIAL_INTANGIBILITY);
        sT = new SpriteType(SPECIAL_INTANGIBILITY_TYPE);
        img = loadImage(imgPath + specialIntangibility);
        sT.addState(PathXCarState.VISIBLE_STATE.toString(), img);
        sT.addState(PathXCarState.MOUSE_OVER_STATE.toString(), img);
        s = new Sprite(sT, 10/*x coordinates*/, 210/*y coordinates*/, 0, 0, PathXCarState.INVISIBLE_STATE.toString());
        guiButtons.put(SPECIAL_INTANGIBILITY_TYPE, s);
        //FLAT TIRE $600
        String specialFlatTire = props.getProperty(PathXPropertyType.SPECIAL_FLAT_TIRE);
        sT = new SpriteType(SPECIAL_FLAT_TIRE_TYPE);
        img = loadImage(imgPath + specialFlatTire);
        sT.addState(PathXCarState.VISIBLE_STATE.toString(), img);
        sT.addState(PathXCarState.MOUSE_OVER_STATE.toString(), img);
        s = new Sprite(sT, 10/*x coordinates*/, 240/*y coordinates*/, 0, 0, PathXCarState.INVISIBLE_STATE.toString());
        guiButtons.put(SPECIAL_FLAT_TIRE_TYPE, s);
        //EMPTY GAS $700
        String specialEmptyGas = props.getProperty(PathXPropertyType.SPECIAL_EMPTY_GAS);
        sT = new SpriteType(SPECIAL_EMPTY_GAS_TYPE);
        img = loadImage(imgPath + specialEmptyGas);
        sT.addState(PathXCarState.VISIBLE_STATE.toString(), img);
        sT.addState(PathXCarState.MOUSE_OVER_STATE.toString(), img);
        s = new Sprite(sT, 10/*x coordinates*/, 270/*y coordinates*/, 0, 0, PathXCarState.INVISIBLE_STATE.toString());
        guiButtons.put(SPECIAL_EMPTY_GAS_TYPE, s);
        //MINDLESS TERROR $800
        String specialMindlessTerror = props.getProperty(PathXPropertyType.SPECIAL_MINDLESS_TERROR);
        sT = new SpriteType(SPECIAL_MINDLESS_TERROR_TYPE);
        img = loadImage(imgPath + specialMindlessTerror);
        sT.addState(PathXCarState.VISIBLE_STATE.toString(), img);
        sT.addState(PathXCarState.MOUSE_OVER_STATE.toString(), img);
        s = new Sprite(sT, 10/*x coordinates*/, 300/*y coordinates*/, 0, 0, PathXCarState.INVISIBLE_STATE.toString());
        guiButtons.put(SPECIAL_MINDLESS_TERROR_TYPE, s);
...
//        //X BUTTON EVENT HANDLER
        ...
        //START BUTTON EVENT HANDLER
         ...
         //SPECIAL STEAL EVENT HANDLER
         guiButtons.get(SPECIAL_STEAL_TYPE).setActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
                eventHandler.respondToStealRequest();
            }
        });
         
         //SPECIAL FLY EVENT HANDLER
         guiButtons.get(SPECIAL_FLY_TYPE).setActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
                setFlyEnabled();
            }
        });
           ...
           //SPECIAL FLY EVENT HANDLER
         guiButtons.get(SPECIAL_INVINCIBILITY_TYPE).setActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
                setInvincibleEnabled();
            }
        });
 
          //SPECIAL INCREASE PLAYER SPEED EVENT HANDLER
         guiButtons.get(SPECIAL_INCREASE_SPEED_TYPE).setActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
                setIncreasedSpeedEnabled();
                eventHandler.respondToIncreasePlayerSpeedRequest();
            }
        });
         
         //SPECIAL PLAYER INTANGIBILITY EVENT HANDLER
         guiButtons.get(SPECIAL_INTANGIBILITY_TYPE).setActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
                
              setIntangibilityEnabled();
            }
        });
         
         //SPECIAL PLAYER INTANGIBILITY EVENT HANDLER
         guiButtons.get(SPECIAL_FLAT_TIRE_TYPE).setActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
                
              setFlattenTireEnabled();
            }
        });

        //SPECIAL PLAYER INTANGIBILITY EVENT HANDLER
        guiButtons.get(SPECIAL_EMPTY_GAS_TYPE).setActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
        ...
        //SPECIAL PLAYER INTANGIBILITY EVENT HANDLER
        guiButtons.get(SPECIAL_MINDLESS_TERROR_TYPE).setActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {

                 setMindlessTerrorEnabled();
            }
        });
...
//    }
    ...
    @Override
    public void reset() {
        ((PathXDataModel)data).resetPlayerBalance();
        for (int i = 0; i < levelList.size(); i++) {
            if (i == 0) {
                levelList.get(i).setLevelKey(1);
            } else {
                levelList.get(i).setLevelKey(0);
            }
    ...
    //FLY
    public static boolean isFlyEnabled = false;
    public void setFlyVisible() {
        guiButtons.get(SPECIAL_FLY_TYPE).setState(PathXCarState.VISIBLE_STATE.toString());
        guiButtons.get(SPECIAL_FLY_TYPE).setEnabled(true);
    }
    public void setFlyEnabled() {
         isFlyEnabled = true;
    }
    public void setFlyDisabled() {
        guiButtons.get(SPECIAL_FLY_TYPE).setState(PathXCarState.INVISIBLE_STATE.toString());
        guiButtons.get(SPECIAL_FLY_TYPE).setEnabled(false);
        isFlyEnabled = false;
    }
    
     //INVINCIBILITY
    public static boolean isInvincibilityEnabled = false;
    public void setInvincibleVisible() {
        guiButtons.get(SPECIAL_INVINCIBILITY_TYPE).setState(PathXCarState.VISIBLE_STATE.toString());
        guiButtons.get(SPECIAL_INVINCIBILITY_TYPE).setEnabled(true);
    }
    public void setInvincibleEnabled() {
         isInvincibilityEnabled = true;
    }
    public void setInvincibleDisabled() {
        guiButtons.get(SPECIAL_INVINCIBILITY_TYPE).setState(PathXCarState.INVISIBLE_STATE.toString());
        guiButtons.get(SPECIAL_INVINCIBILITY_TYPE).setEnabled(false);
        isInvincibilityEnabled = false;
    }
    
     //INTANGIBILITY
    public static boolean isIntagibilityEnabled = false;
    public void setIntangibilityVisible() {
        guiButtons.get(SPECIAL_INTANGIBILITY_TYPE).setState(PathXCarState.VISIBLE_STATE.toString());
        guiButtons.get(SPECIAL_INTANGIBILITY_TYPE).setEnabled(true);
    }

    public void setIntangibilityEnabled() {
        isIntagibilityEnabled = true;
  
    }
    public void setIntangibilityDisabled() {
        guiButtons.get(SPECIAL_INTANGIBILITY_TYPE).setState(PathXCarState.INVISIBLE_STATE.toString());
        guiButtons.get(SPECIAL_INTANGIBILITY_TYPE).setEnabled(false);
        isIntagibilityEnabled = false;
    }
    
     //FLATTEN TIRE
    public static boolean isFlattenTireEnabled = false;
    public void setFlattenTireVisible() {
        guiButtons.get(SPECIAL_FLAT_TIRE_TYPE).setState(PathXCarState.VISIBLE_STATE.toString());
        guiButtons.get(SPECIAL_FLAT_TIRE_TYPE).setEnabled(true);
    }

    public void setFlattenTireEnabled() {
        isFlattenTireEnabled = true;
  
    }
    public void setFlattenTireDisabled() {
        guiButtons.get(SPECIAL_FLAT_TIRE_TYPE).setState(PathXCarState.INVISIBLE_STATE.toString());
        guiButtons.get(SPECIAL_FLAT_TIRE_TYPE).setEnabled(false);
        isFlattenTireEnabled = false;
    }
    
    //EMPTY GAS
    public static boolean isEmptyGasEnabled = false;
    public void setEmptyGasVisible() {
        guiButtons.get(SPECIAL_EMPTY_GAS_TYPE).setState(PathXCarState.VISIBLE_STATE.toString());
        guiButtons.get(SPECIAL_EMPTY_GAS_TYPE).setEnabled(true);
    }

    public void setEmptyGasEnabled() {
        isEmptyGasEnabled = true;
  
    }
    public void setEmptyGasDisabled() {
        guiButtons.get(SPECIAL_EMPTY_GAS_TYPE).setState(PathXCarState.INVISIBLE_STATE.toString());
        guiButtons.get(SPECIAL_EMPTY_GAS_TYPE).setEnabled(false);
        isEmptyGasEnabled = false;
    }
    
    //MINDLESS TERROR
    public static boolean isMindlessTerrorEnabled = false;
    public void setMindlessTerrorVisible() {
        guiButtons.get(SPECIAL_MINDLESS_TERROR_TYPE).setState(PathXCarState.VISIBLE_STATE.toString());
        guiButtons.get(SPECIAL_MINDLESS_TERROR_TYPE).setEnabled(true);
    }

    public void setMindlessTerrorEnabled() {
        isMindlessTerrorEnabled = true;
  
    }
    public void setMindlessTerrorDisabled() {
        guiButtons.get(SPECIAL_MINDLESS_TERROR_TYPE).setState(PathXCarState.INVISIBLE_STATE.toString());
        guiButtons.get(SPECIAL_MINDLESS_TERROR_TYPE).setEnabled(false);
        isMindlessTerrorEnabled = false;
    }
    
     //SPEED INCREASE
    public static boolean isIncreasedSpeedEnabled = false;
    public void setIncreasedSpeedVisible() {
        guiButtons.get(SPECIAL_INCREASE_SPEED_TYPE).setState(PathXCarState.VISIBLE_STATE.toString());
        guiButtons.get(SPECIAL_INCREASE_SPEED_TYPE).setEnabled(true);
    }
    public void setIncreasedSpeedEnabled() {
         isIncreasedSpeedEnabled = true;
    }
    public void setIncreasedSpeedDisabled() {
        guiButtons.get(SPECIAL_INCREASE_SPEED_TYPE).setState(PathXCarState.INVISIBLE_STATE.toString());
        guiButtons.get(SPECIAL_INCREASE_SPEED_TYPE).setEnabled(false);
        isIncreasedSpeedEnabled = false;
    }
    //STEAL
    public static boolean isStealEnabled = false;
    public void setStealthVisible() {
        guiButtons.get(SPECIAL_STEAL_TYPE).setState(PathXCarState.VISIBLE_STATE.toString());
        guiButtons.get(SPECIAL_STEAL_TYPE).setEnabled(true);
    }
    public void setStealEnabled() {
        isStealEnabled = true;
    }
    public void setStealDisabled() {
        guiButtons.get(SPECIAL_STEAL_TYPE).setState(PathXCarState.INVISIBLE_STATE.toString());
        guiButtons.get(SPECIAL_STEAL_TYPE).setEnabled(false);
        isStealEnabled = false;
    }
